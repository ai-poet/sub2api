...
export const PAYMENT_TYPE_META: Record<string, PaymentTypeMeta> = {
  ...
  [PAYMENT_TYPE.USDT_PLASMA]: {
    ...
    iconBg: 'bg-[#26A17B]',
    chartBar: { light: 'bg-emerald-500', dark: 'bg-emerald-400' },
    buttonClass: 'bg-[#26A17B] hover:bg-[#208865] active:bg-[#1b7355]',
  },
  [PAYMENT_TYPE.USDT_POLYGON]: {
    label: 'USDT',
    sublabel: 'Polygon',
    provider: '易支付',
    color: '#8247E5',
    ...
    selectedBgDark: 'bg-violet-950',
    iconBg: 'bg-[#8247E5]',
    chartBar: { light: 'bg-violet-500', dark: 'bg-violet-400' },
    buttonClass: 'bg-[#8247E5] hover:bg-[#6d39c9] active:bg-[#5c30ab]',
  },
  [PAYMENT_TYPE.USDC_SOLANA]: {
    label: 'USDC',
    sublabel: 'Solana',
    provider: '易支付',
    color: '#2775CA',
    ...
    selectedBgDark: 'bg-sky-950',
    iconBg: 'bg-[#2775CA]',
    chartBar: { light: 'bg-sky-500', dark: 'bg-sky-400' },
    buttonClass: 'bg-[#2775CA] hover:bg-[#2164ad] active:bg-[#1b538f]',
  },
  [PAYMENT_TYPE.STRIPE]: {
    label: 'Stripe',
    provider: 'Stripe',
...
const PAYMENT_TEXT_MAP: Record<Locale, Record<string, { label: string; provider: string; sublabel?: string }>> = {
  zh: {
    ...
    [PAYMENT_TYPE.USDT_PLASMA]: { label: 'USDT', provider: '易支付', sublabel: 'Plasma' },
  ...
  en: {
    ...
    [PAYMENT_TYPE.USDT_PLASMA]: { label: 'USDT', provider: 'EasyPay', sublabel: 'Plasma' },
