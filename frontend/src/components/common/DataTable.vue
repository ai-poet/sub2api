...
.table-wrapper::-webkit-scrollbar-thumb {
  background-color: rgba(122, 114, 104, 0.75) !important; 
  border-radius: 6px !important;
...
.table-wrapper::-webkit-scrollbar-thumb:hover {
  background-color: rgba(77, 72, 66, 0.9) !important;
}

.dark .table-wrapper::-webkit-scrollbar-thumb {
  background-color: rgba(168, 161, 153, 0.75) !important;
}
.dark .table-wrapper::-webkit-scrollbar-thumb:hover {
  background-color: rgba(207, 201, 193, 0.9) !important;
}
...
@supports (-moz-appearance:none) {
  .table-wrapper {
    ...
    scrollbar-color: rgba(168, 161, 153, 0.5) rgba(0, 0, 0, 0.03) !important;
  }
  .dark .table-wrapper {
    scrollbar-color: rgba(77, 72, 66, 0.5) rgba(255, 255, 255, 0.05) !important;
  }
}
</style>
