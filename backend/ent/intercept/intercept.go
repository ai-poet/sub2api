...
// The AdminApprovalRequestFunc type is an adapter to allow the use of ordinary function as a Querier.
type AdminApprovalRequestFunc func(context.Context, *ent.AdminApprovalRequestQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f AdminApprovalRequestFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.AdminApprovalRequestQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.AdminApprovalRequestQuery", q)
}

// The TraverseAdminApprovalRequest type is an adapter to allow the use of ordinary function as Traverser.
type TraverseAdminApprovalRequest func(context.Context, *ent.AdminApprovalRequestQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseAdminApprovalRequest) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseAdminApprovalRequest) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.AdminApprovalRequestQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.AdminApprovalRequestQuery", q)
}
...
// The UserReferralFunc type is an adapter to allow the use of ordinary function as a Querier.
type UserReferralFunc func(context.Context, *ent.UserReferralQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f UserReferralFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.UserReferralQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.UserReferralQuery", q)
}

// The TraverseUserReferral type is an adapter to allow the use of ordinary function as Traverser.
type TraverseUserReferral func(context.Context, *ent.UserReferralQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseUserReferral) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseUserReferral) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.UserReferralQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.UserReferralQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.AdminApprovalRequestQuery:
		return &query[*ent.AdminApprovalRequestQuery, predicate.AdminApprovalRequest, adminapprovalrequest.OrderOption]{typ: ent.TypeAdminApprovalRequest, tq: q}, nil
	...
	case *ent.UserReferralQuery:
		return &query[*ent.UserReferralQuery, predicate.UserReferral, userreferral.OrderOption]{typ: ent.TypeUserReferral, tq: q}, nil
