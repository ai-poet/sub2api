...
const apiKeyAuthSnapshotVersion = 24 // v24: upstream v23 (group codex_models_manifest_config) merged on top of local long-context/model pricing fields (local v23 = upstream v22 + local fields)
