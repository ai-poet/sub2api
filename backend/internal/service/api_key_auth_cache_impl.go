...
const apiKeyAuthSnapshotVersion = 23 // v23: upstream v22 (group free_openai_fast, restrict_public_groups) merged on top of local long-context/model pricing fields
