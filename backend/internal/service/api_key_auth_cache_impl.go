...
const apiKeyAuthSnapshotVersion = 25 // v25: upstream v24 (group model_allowlist, renamed from models_list_config) merged on top of local long-context/model pricing fields (local v24 = upstream v23 + local fields)
