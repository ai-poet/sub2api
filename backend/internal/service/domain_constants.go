...
const (
	...
	SettingKeyPurchaseSubscriptionURL      = “purchase_subscription_url”      // “购买订阅”页面 URL
	SettingKeyPurchaseSubscriptionOpenMode = “purchase_subscription_open_mode” // “购买订阅”页面打开方式：iframe（内嵌）或 new_window（新窗口）
