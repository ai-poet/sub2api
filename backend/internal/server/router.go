...
func SetupRouter(
	...
	// 注册路由
	registerRoutes(r, handlers, jwtAuth, adminAuth, apiKeyAuth, auditLog, stepUpAuth, apiKeyService, subscriptionService, userService, opsService, settingService, compositeResolver, cfg, redisClient)
