		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeyClientDownloadWindowsURL: "https://downloads.example.com/cheaprouter.exe",
			...
			wantJSON: `{
				...
				"data": {
					...
					"client_download_windows_url": "https://downloads.example.com/cheaprouter.exe",
