...
func registerGroupRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	groups := admin.Group("/groups")
	{
		...
		groups.GET("/runtime-status/summary", h.Admin.Group.GetRuntimeStatusSummary)
		...
		groups.GET("/:id/runtime-status", h.Admin.Group.GetRuntimeStatus)
...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.POST("/group-status-notify/test", h.Admin.Setting.TestGroupStatusNotify)
